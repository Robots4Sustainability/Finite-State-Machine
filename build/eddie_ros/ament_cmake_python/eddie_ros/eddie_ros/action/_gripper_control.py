...
class Metaclass_GripperControl_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('eddie_ros')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl_Goal')
            logger.debug(
...
class Metaclass_GripperControl_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_GripperControl_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperControl_SendGoal_Request(metaclass=Metaclass_GripperControl_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'eddie_ros/GripperControl_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from eddie_ros.action._gripper_control import GripperControl_Goal
...
class Metaclass_GripperControl_SendGoal_Event(type):
    """Metaclass of message 'GripperControl_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__gripper_control__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__gripper_control__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__gripper_control__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__gripper_control__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__gripper_control__send_goal__event
...
class GripperControl_SendGoal_Event(metaclass=Metaclass_GripperControl_SendGoal_Event):
    """Message class 'GripperControl_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<eddie_ros/GripperControl_SendGoal_Request, 1>',
        'response': 'sequence<eddie_ros/GripperControl_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from eddie_ros.action import GripperControl_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GripperControl_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GripperControl_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from eddie_ros.action import GripperControl_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GripperControl_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GripperControl_SendGoal_Response'"
...
class Metaclass_GripperControl_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from eddie_ros.action import _gripper_control
            ...
            if _gripper_control.Metaclass_GripperControl_SendGoal_Event._TYPE_SUPPORT is None:
                _gripper_control.Metaclass_GripperControl_SendGoal_Event.__import_type_support__()


class GripperControl_SendGoal(metaclass=Metaclass_GripperControl_SendGoal):
    from eddie_ros.action._gripper_control import GripperControl_SendGoal_Request as Request
    from eddie_ros.action._gripper_control import GripperControl_SendGoal_Response as Response
    from eddie_ros.action._gripper_control import GripperControl_SendGoal_Event as Event
...
class GripperControl_GetResult_Response(metaclass=Metaclass_GripperControl_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'eddie_ros/GripperControl_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from eddie_ros.action._gripper_control import GripperControl_Result
...
class Metaclass_GripperControl_GetResult_Event(type):
    """Metaclass of message 'GripperControl_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__gripper_control__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__gripper_control__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__gripper_control__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__gripper_control__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__gripper_control__get_result__event
...
class GripperControl_GetResult_Event(metaclass=Metaclass_GripperControl_GetResult_Event):
    """Message class 'GripperControl_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<eddie_ros/GripperControl_GetResult_Request, 1>',
        'response': 'sequence<eddie_ros/GripperControl_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from eddie_ros.action import GripperControl_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GripperControl_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GripperControl_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from eddie_ros.action import GripperControl_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GripperControl_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GripperControl_GetResult_Response'"
        self._response = value
...
class Metaclass_GripperControl_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _gripper_control.Metaclass_GripperControl_GetResult_Event._TYPE_SUPPORT is None:
                _gripper_control.Metaclass_GripperControl_GetResult_Event.__import_type_support__()


class GripperControl_GetResult(metaclass=Metaclass_GripperControl_GetResult):
    from eddie_ros.action._gripper_control import GripperControl_GetResult_Request as Request
    from eddie_ros.action._gripper_control import GripperControl_GetResult_Response as Response
    from eddie_ros.action._gripper_control import GripperControl_GetResult_Event as Event
...
class Metaclass_GripperControl_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperControl_FeedbackMessage(metaclass=Metaclass_GripperControl_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'eddie_ros/GripperControl_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['eddie_ros', 'action'], 'GripperControl_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from eddie_ros.action._gripper_control import GripperControl_Feedback
...
class Metaclass_GripperControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eddie_ros.action.GripperControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperControl(metaclass=Metaclass_GripperControl):
    ...
    from eddie_ros.action._gripper_control import GripperControl_Goal as Goal
    # The result message defined in the action definition.
    from eddie_ros.action._gripper_control import GripperControl_Result as Result
    # The feedback message defined in the action definition.
    from eddie_ros.action._gripper_control import GripperControl_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from eddie_ros.action._gripper_control import GripperControl_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from eddie_ros.action._gripper_control import GripperControl_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from eddie_ros.action._gripper_control import GripperControl_FeedbackMessage as FeedbackMessage
