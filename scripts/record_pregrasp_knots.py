...
class PregraspKnotRecorder(Node):
    def __init__(self):
        ...
        self.declare_parameter("marker_name", "pregrasp_knot_marker")
        ...
        self.marker_server = InteractiveMarkerServer(self, "pregrasp_knot_marker_server")
        ...
        self.get_logger().info("Pregrasp knot recorder ready.")
        self.get_logger().info(
            "Open RViz, add an InteractiveMarkers display, and subscribe to "
            "/pregrasp_knot_marker_server/update."
        )
        self.get_logger().info(
    ...
    def build_marker(self, pose):
        ...
        marker.description = "Pregrasp Knot Recorder"
